...
easy to write. This is accomplished by using white-space to deliniate code blocks
...
which is largly based on white space, and designed to be clean and readable.
"""
...
Python version 2.7.3, released in 2012, is the last iteration of verison 2 that was released.
 This verison is for the most part, backwards compatiable with all previous versions.

In 2008, the Founder, Guido van Rossum decided to clean up the Python codebase
and overhall a lot of the things in Python 2 that he didn’t like, thus creating Python 3.
...
### Choosing an IDE
"""
Many developers choose to write Python using a specilized integrated development enviornment.
